...
/**
 * innermost click redirect
 */
var menu_title = document.getElementsByClassName('menu-title')
console.log(menu_title)
Array.prototype.forEach.call(menu_title, function(el) {
  el.addEventListener('click', function() { 
    if(el.innerHTML == "Light"){
